...
type Config struct {
	...
	FunctionDependencies []string   `protobuf:"bytes,5,rep,name=functionDependencies,proto3" json:"functionDependencies,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *Config) GetFunctionDependencies() []string {
	if x != nil {
...
const file_proto_common_common_proto_rawDesc = "" +
	...
	"\x0fmax_concurrency\x18\x04 \x01(\x05R\x0emaxConcurrency\x122\n" +
	"\x14functionDependencies\x18\x05 \x03(\tR\x14functionDependencies\"9\n" +
	"\tCPUConfig\x12\x16\n" +
